...
class MenuButton extends StatelessWidget {
  static final String refresh = tr('menu_refresh');
  static final String vacationsRequests = tr('menu_vacations_requests');
  static final String employees = tr('menu_employees');
  static final String users = tr('menu_users');
  static final String createNewAdmin = tr('menu_create_new_admin');
  static final String vacations = tr('menu_vacations_types');
  static final String englishLanguage = 'English';
  static final String arabicLanguage = 'العربية';
  static final String editMyAccount = tr('menu_edit_my_account');
  static final String resetPassword = tr('menu_reset_password');
  static final String deleteMyAccount = tr('menu_delete_my_account');
  static final String signOut = tr('menu_sign_out');
  static final String resetVacations = tr('menu_reset_vacations');
  ...
  void initChoices(BuildContext context) {
    var rule = Provider.of<CurrentUserRule>(context).rule;
    if (rule == 1)
      choices = [
        refresh,
        vacations,
